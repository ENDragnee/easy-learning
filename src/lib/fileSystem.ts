      ...
      subjects: [
        {
          ...
          chapters: [
            ...
            { name: 'chapter5', subChapters: ['5.1 Conductors Insulators and Semiconductors', '5.2 Diodes and their Functions', '5.3 Rectification', '5.4 Transistors and Their Application', '5.5 Integrated Circuits', '5.6 Logic Gates and Logic Circuits', '5.7 Applications of Electronics'] },
          ],
        },
        {
          name: 'chemistry',
          chapters: [
            { name: 'chapter1', subChapters: ['1.1 Acid-Base Concepts', '1.2 Ionic Equilibria of Weak Acids and Bases', '1.3 Common-Ion Effect and Buffer Solutions', '1.4 Hydrolysis of Salts', '1.5 AcidBase Indicators and Titrations'] },
            { name: 'chapter2', subChapters: ['2.1 OxidationReduction Reactions', '2.2 Electrolysis of Aqueous Solutions', '2.3 Quantitative Aspects of Electrolysis', '2.4 Industrial Application of Electrolysis', '2.5 Voltaic Cells'] },
            { name: 'chapter3', subChapters: ['3.1 Introduction', '3.2 Natural Resources and Industry', '3.3 Manufacturing of Valuable Products Chemicals', '3.4 Some Manufacturing Industries in Ethiopia'] },
            { name: 'chapter4', subChapters: ['4.1 Introduction to Polymers', '4.2 Polymerization Reactions', '4.3 Classification of Polymers'] },
            { name: 'chapter5', subChapters: ['5.1 Environmental Chemistry', '5.2 Environmental Pollution', '5.3 Global Warming and Climate Change', '5.4 Green Chemistry and Cleaner Production'] },
          ],
        },
      ],
    },
